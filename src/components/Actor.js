                                    ...
                                    <section id="original_header" className={styles.inner}>
                                        <div className={styles.poster_wrapper}>
                                            <div className={styles.image_content}>
                                                <img className={styles.profile} src={`https://image.tmdb.org/t/p/original/${actor.details.profile_path}`} alt={actor.details.id} />
                                            </div>
                                        </div>
                                    </section>
                                    <div class="column">
                                        <section className={styles.facts}>
                                            ...
                                            <section>
                                                <p><strong><bdi>Known For: </bdi></strong>{actor.details.known_for_department} </p>
                                                <p><strong><bdi>Gender: </bdi></strong> {actor.details.gender == 1 ? "Female" : "Male"}</p>

                                                <p class="full">
                                                    <strong><bdi>Birthday: </bdi></strong>
                                                    {actor.details.birthday}
                                                </p>
                                                <p class="full"><strong><bdi>Place of Birth: </bdi></strong>  {actor.details.place_of_birth}</p>
                                            </section>
                                        </section>
                                    </div>
                                </div>) : null}
